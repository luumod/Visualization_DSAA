...
/**
 * @brief Visualization of shell sort.
 */
class ShellSort : public SortObject
{
public:
    /**
     * @brief Constructor of shell sort.
     */
    explicit ShellSort(QObject *parent = nullptr);

    /**
    * @brief Implement of shell sort. This is an override function.
    ...
    */
    ...
    /**
    * @brief Stopped when shell sort is running. This is an override function.
    */
    void stop() override;

    /**
     * @brief Draw method of the shell sort. This is an override function.
