	...
	PageWidget(parent)
{
	...
	_titleLabel = new QLabel("Linked list", _contentWidget);
	...
	_pageDesc->setText("Visualization of linked list algorithm");
...
PushButton* LinkedListPage::getPageIconButton(QWidget* context) {
	...
	_iconButtonLabel->setText(FontAwesomeIcons::Instance()->getIconChar(FontAwesomeIcons::IconIdentity::icon_arrow_in));
...
PushButton* LinkedListPage::getPageTextButton(QWidget* context) {
	...
	_textButtonIcon->setText(FontAwesomeIcons::Instance()->getIconChar(FontAwesomeIcons::IconIdentity::icon_arrow_in));
	...
	_textButtonLabel->setText("Linked list");
