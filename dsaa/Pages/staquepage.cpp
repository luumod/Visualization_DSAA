...
StaquePage::StaquePage(QWidget* parent) :
	PageWidget(parent)
{
#if DEBUG
	...
	staqueCanvas = new StaqueCanvas(20,
		"Linked List",
	...
	_mainOperateLayout->addWidget(staqueCanvas);
...
StaquePage::~StaquePage() {}

void StaquePage::autoResizeSettingsPage() {
	staqueCanvas->settingPage()->autoResize();
}

PushButton* StaquePage::getPageIconButton(QWidget* context) {
...
PushButton* StaquePage::getPageTextButton(QWidget* context) {
	// Check for existed button
