...
#include <memory>
#include "../../../../../../dsaa/conponents/pushbutton.h"
...
QT_MOC_LITERAL(19, 0), // ""
QT_MOC_LITERAL(20, 7), // "onHover"
QT_MOC_LITERAL(28, 9) // "onPressed"

    },
    "PushButton\0onClick\0\0onHover\0onPressed"
};
...
void PushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PushButton::onClick)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (PushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PushButton::onHover)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (PushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PushButton::onPressed)) {
                *result = 2;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<PushButton, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
