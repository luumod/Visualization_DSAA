...
#include <memory>
#include "../../../../../../dsaa/conponents/sidebar.h"
...
QT_MOC_LITERAL(8, 13), // "onPageChanged"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 11), // "PageWidget*"
QT_MOC_LITERAL(35, 12), // "previousPage"
QT_MOC_LITERAL(48, 11) // "currentPage"

    },
    "SideBar\0onPageChanged\0\0PageWidget*\0"
    "previousPage\0currentPage"
};
...
void SideBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->onPageChanged((*reinterpret_cast< std::add_pointer_t<PageWidget*>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<PageWidget*>>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SideBar::*)(PageWidget * , PageWidget * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SideBar::onPageChanged)) {
                *result = 0;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<SideBar, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<PageWidget *, std::false_type>, QtPrivate::TypeAndForceComplete<PageWidget *, std::false_type>
...
// SIGNAL 0
void SideBar::onPageChanged(PageWidget * _t1, PageWidget * _t2)
{
